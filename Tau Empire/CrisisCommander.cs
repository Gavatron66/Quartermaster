...
namespace Roster_Builder.Tau_Empire
{
    public class CrisisCommander : Datasheets
    {
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            cbOption1.Text = "Iridium Battlesuit";
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            {
                if(weapon == "Airbursting Fragmentation Projector")
                {
                    weapons[0] += 1;
                    if (weapons[0] == 1)
                    {
                ...
                else if (weapon == "Cyclic Ion Blaster")
                {
                    weapons[2] += 1;
                    if (weapons[2] == 1)
                    {
                ...
                else if (weapon == "Gun Drone")
                {
                    Points += 10;
                }
                else if (weapon == "Iridium Battlesuit")
                {
                    Points += 10;
                }
                else if (weapon == "Marker Drone")
                {
                    Points += 10;
                }
                else if (weapon == "Shield Drone")
                {
                    Points += 15;
                }
                else if (weapon == "Shield Generator")
                {
                    Points += 10;
                }
            }
