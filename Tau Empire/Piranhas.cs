...
{
    public class Piranhas : Datasheets
    {
        int currentIndex;
        ...
        public Piranhas()
        {
            ...
            TemplateCode = "NL1m2k";
            Weapons.Add("Piranha Burst Cannon");
            Weapons.Add("");
            Weapons.Add("");
            Keywords.AddRange(new string[]
            {
                "T'AU EMPIRE", "<SEPT>",
                "VEHICLE", "FLY", "PIRANHAS"
            });
            Role = "Fast Attack";
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            {
                lbModelSelect.Items.Add("Piranha w/ " + Weapons[i * 3]);
            }
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                case 11:
                    ...
                    lbModelSelect.Items[currentIndex] = "Piranha w/ " + Weapons[currentIndex * 3];
                    break;
                case 21:
                ...
                case 61:
                    ...
                    if (Weapons[(currentIndex * 3) + 1] == "Seeker Missile (+5 pts)")
                    {
                        cbOption1.Checked = true;
                    }
                    else
                    ...
                    if (Weapons[(currentIndex * 3) + 2] == "Seeker Missile (+5 pts)")
                    {
                        cbOption2.Checked = true;
                    }
                    else
            ...
            {
                if (weapon == "Piranha Fusion Blaster (+10 pts)")
                {
                    Points += 10;
                }
