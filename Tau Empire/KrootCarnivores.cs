...
{
    public class KrootCarnivores : Datasheets
    {
        public KrootCarnivores()
        {
            UnitSize = 10;
            DEFAULT_POINTS = 7;
            ...
            {
                "T'AU EMPIRE", "KROOT",
                "INFANTRY", "T'AU AUXILIARY", "KROOT CARNIVORES"
            });
            Role = "Troops";
        }
        ...
        {
            return "Kroot Carnivores - " + Points + "pts";
        }
    }
}
