...
{
    public class TS_Sorcerer : Datasheets
    {
        public TS_Sorcerer()
        {
            DEFAULT_POINTS = 90;
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                ...
                case 17:
                    ...
                    if(chosenRelic == "Seer's Bane")
                    {
                        cmbOption2.SelectedIndex = 1;
                        cmbOption2.Enabled = false;
                    }
                    else if(chosenRelic == "Coruscator")
                    {
                        cmbOption1.SelectedIndex = 0;
                        cmbOption1.Enabled = false;
                    }
                    else if(chosenRelic == "Skaeloch's Talon" || chosenRelic == "Incandaeum" || chosenRelic == "The Stave Abominus")
                    {
                        cmbOption2.SelectedIndex = 0;
                        cmbOption2.Enabled = false;
                    }
                    else if(chosenRelic == "Incaladion's Cry")
                    {
