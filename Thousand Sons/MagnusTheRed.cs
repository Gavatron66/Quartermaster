...
{
    public class MagnusTheRed : Datasheets
    {
        public MagnusTheRed()
        {
            DEFAULT_POINTS = 420;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "CHARACTER", "MONSTER", "DAEMON", "PRIMARCH", "SUPREME COMMANDER", "FLY", "PSYKER", "MAGNUS THE RED"
            });
            PsykerPowers = new string[3] { string.Empty, string.Empty, string.Empty };
            WarlordTrait = "Arrogance of Aeons, Undying Form, Lord of Forbidden Lore";
            Role = "Lord of War";
        }

        public override Datasheets CreateUnit()
        {
            return new MagnusTheRed();
        }
        ...
        {
            return "Magnus the Red - " + Points + "pts";
        }
    }
}
