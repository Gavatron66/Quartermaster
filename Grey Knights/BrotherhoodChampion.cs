...
{
    public class BrotherhoodChampion : Datasheets
    {
        public BrotherhoodChampion()
        {
            DEFAULT_POINTS = 60;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "PSYKER", "PSYK-OUT GRENADES", "BROTHERHOOD CHAMPION"
            });
        ...
        {
            return new BrotherhoodChampion();
        }
        ...
        {
            return "Brotherhood Champion - " + Points + "pts";
        }
    }
}
