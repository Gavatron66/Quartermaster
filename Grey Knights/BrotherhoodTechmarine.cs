...
{
    public class BrotherhoodTechmarine : Datasheets
    {
        public BrotherhoodTechmarine()
        {
            DEFAULT_POINTS = 70;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "PSYKER", "PSYK-OUT GRENADES", "BROTHERHOOD TECHMARINE"
            });
        ...
        {
            return new BrotherhoodTechmarine();
        }
        ...
        {
            return "Brotherhood Techmarine - " + Points + "pts";
        }
    }
}