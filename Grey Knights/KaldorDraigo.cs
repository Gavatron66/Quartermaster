...
{
    public class KaldorDraigo : Datasheets
    {
        public KaldorDraigo()
        {
            DEFAULT_POINTS = 165;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "PSYKER", "PSYK-OUT GRENADES", "SUPREME GRAND MASTER", "TERMINATOR",
                "HONOURED KNIGHT", "KALDOR DRAIGO"
            });
            PsykerPowers = new string[3] { string.Empty, string.Empty, string.Empty };
            WarlordTrait = "Daemon-slayer";
            Role = "HQ";
        }

        public override Datasheets CreateUnit()
        {
            return new KaldorDraigo();
        }
        ...
        {
            return "Kaldor Draigo - " + Points + "pts";
        }
    }
}
