...
{
    public class Purifiers : Datasheets
    {
        int currentIndex;
        int restriction = 1;
        public Purifiers()
        {
            ...
            {
                "IMPERIUM", "SANCTIC ASTARTES", "GREY KNGIHTS", "PURIFIER",
                "INFANTRY", "CORE", "PSYKER", "PSYK-OUT GRENADES", "HONOURED KNIGHT", "PALADIN SQUAD"
            });
            Role = "Elites";
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            lbModelSelect.Items.Add("Knight of the Flame w/ " + Weapons[0] + " and " + Weapons[1]);
            for (int i = 1; i < UnitSize; i++)
            {
                lbModelSelect.Items.Add("Purifier w/ " + Weapons[(i * 2)] + " and " + Weapons[(i * 2) + 1]);
            }
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                case 11:
                    ...
                    if (currentIndex == 0)
                    {
                        lbModelSelect.Items[0] = "Knight of the Flame w/ " + Weapons[0] + " and " + Weapons[1];
                    }
                    else
                    {
                        lbModelSelect.Items[currentIndex] = "Purifier w/ " + Weapons[(currentIndex * 2)]
                ...
                case 30:
                    ...
                    if (temp < UnitSize)
                    {
                        for (int i = temp; i < UnitSize; i++)
                        {
                            Weapons.Add("Storm Bolter");
                            Weapons.Add("Nemesis Force Sword");
                            lbModelSelect.Items.Add("Purifier w/ " + Weapons[(currentIndex * 2)]
                                + " and " + Weapons[(currentIndex * 2) + 1]);
                        }
                    }
        ...
        {
            return "Purifier Squad - " + Points + "pts";
        }
    }
}