...
{
    public class BrotherhoodLibrarian : Datasheets
    {
        private string stratWarlordTrait;

        public BrotherhoodLibrarian()
        {
            DEFAULT_POINTS = 95;
            Points = DEFAULT_POINTS;
            TemplateCode = "2m_pc";
            Weapons.Add("Nemesis Warding Stave");
            Weapons.Add("(None)");
            Keywords.AddRange(new string[]
            {
                "IMPERIUM", "SANCTIC ASTARTES", "GREY KNIGHTS", "<BROTHERHOOD>",
                "INFANTRY", "CHARACTER", "PSYKER", "PSYK-OUT GRENADES", "TERMINATOR", "BROTHERHOOD LIBRARIAN"
            });
        ...
        {
            return new BrotherhoodLibrarian();
        }
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                ...
                case 17:
                    ...
                    else if (chosenRelic == "Fury of Deimos")
                    {
        ...
        {
            return "Brotherhood Librarian - " + Points + "pts";
        }
    }
}
