...
{
    public class GMVoldus : Datasheets
    {
        public GMVoldus()
        {
            DEFAULT_POINTS = 135;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "PSYKER", "PSYK-OUT GRENADES", "GRAND MASTER", "TERMINATOR",
                "GRAND MASTER VOLDUS"
            });
            PsykerPowers = new string[3] { string.Empty, string.Empty, string.Empty };
            WarlordTrait = "Loremaster";
            Role = "HQ";
        }
        ...
        {
            return "Grand Master Voldus - " + Points + "pts";
        }
    }
}
