...
{
    public class GKLandRaiderRedeemer : Datasheets
    {
        public GKLandRaiderRedeemer()
        {
            ...
            {
                "IMPERIUM", "SANCTIC ASTARTES", "GREY KNIGHTS", "<CHAPTER>",
        ...
        {
            return new GKLandRaiderRedeemer();
        }
        ...
        {
            return "Land Raider Redeemer - " + Points + "pts";
        }
    }
}
