...
{
    public class BrotherhoodChaplain : Datasheets
    {
        List<string> dominusPowers;
        List<string> litanies;
        private string stratWarlordTrait;

        public BrotherhoodChaplain()
        {
            DEFAULT_POINTS = 100;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "PSYKER", "PSYK-OUT GRENADES", "BROTHERHOOD CHAPLAIN"
            });
        ...
        {
            return new BrotherhoodChaplain();
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            dominusPowers = repo.GetPsykerPowers("Dominus");
            clbPsyker.Items.Clear();
            foreach (string power in dominusPowers)
            {
                clbPsyker.Items.Add(power);
            }
            litanies = repo.GetPsykerPowers("Litany");
            foreach (string power in litanies)
            {
                clbPsyker.Items.Add(power);
            }
            ...
            panel.Controls["lblOption6"].Location = new System.Drawing.Point(panel.Controls["lblPsyker"].Location.X, panel.Controls["lblPsyker"].Location.Y + clbPsyker.Height + 67);
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                ...
                case 60:
                    ...
                    {
                        if (dominusPowers.Contains(clbPsyker.CheckedItems[0]) && litanies.Contains(clbPsyker.CheckedItems[1])
                            || dominusPowers.Contains(clbPsyker.CheckedItems[1]) && litanies.Contains(clbPsyker.CheckedItems[0]))
                        {
        ...
        {
            return "Brotherhood Chaplain - " + Points + "pts";
        }
    }
}
