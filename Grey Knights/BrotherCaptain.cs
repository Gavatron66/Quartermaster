...
{
    public class BrotherCaptain : Datasheets
    {
        private string stratWarlordTrait;

        public BrotherCaptain()
        {
            DEFAULT_POINTS = 100;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "PSYKER", "PSYK-OUT GRENADES", "TERMINATOR", "BROTHER-CAPTAIN"
            });
        ...
        {
            return "Brother-Captain - " + Points + "pts";
        }
    }
}
