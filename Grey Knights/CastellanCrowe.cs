...
{
    public class CastellanCrowe : Datasheets
    {
        public CastellanCrowe()
        {
            DEFAULT_POINTS = 85;
            UnitSize = 1;
            ...
            {
                "IMPERIUM", "SANCTIC ASTARTES", "GREY KNIGHTS", "PURIFIER",
                "INFANTRY", "CHARACTER", "PSYKER", "PSYK-OUT GRENADES", "HONOURED KNIGHT", "CASTELLAN CROWE"
            });
            PsykerPowers = new string[1] { string.Empty };
            WarlordTrait = "Hammer of Righteousness";
            Role = "HQ";
        }

        public override Datasheets CreateUnit()
        {
            return new CastellanCrowe();
        }
        ...
        {
            return "Castellan Crowe - " + Points + "pts";
        }
    }
}
