...
{
    public class BrotherhoodAncient : Datasheets
    {
        public BrotherhoodAncient()
        {
            DEFAULT_POINTS = 90;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "PSYKER", "PSYK-OUT GRENADES", "ANCIENT", "TERMINATOR", "BROTHERHOOD ANCIENT"
            });
        ...
        {
            return "Brotherhood Ancient - " + Points + "pts";
        }
    }
}