...
{
    public class GrandMaster : Datasheets
    {
        ...
        public GrandMaster()
        {
            ...
            TemplateCode = "2m_pc";
            Weapons.Add("Nemesis Force Halberd");
            Weapons.Add("Master-crafted Storm Bolter");
            Keywords.AddRange(new string[]
            {
                "IMPERIUM", "SANCTIC ASTARTES", "GREY KNIGHTS", "<BROTHERHOOD>",
                "INFANTRY", "CHARACTER", "PSYKER", "PSYK-OUT GRENADES", "TERMINATOR", "GRAND MASTER"
            });
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                ...
                case 17:
                    ...
                    if (chosenRelic == "Destroyer of Crys'yllix")
                    {
        ...
        {
            return "Grand Master - " + Points + "pts";
        }
    }
}
