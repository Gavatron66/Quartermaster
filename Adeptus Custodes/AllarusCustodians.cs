...
{
    public class AllarusCustodians : Datasheets
    {
        int currentIndex = 0;
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            for (int i = 0; i < UnitSize; i++)
            {
                if (Weapons[(i * 2) + 1] != "")
                {
                    lbModelSelect.Items.Add("Allarus Custodian w/ " + Weapons[i * 2]
                        + " and a " + Weapons[(i * 2) + 1]);
                }
                else
                {
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                case 11:
                    ...
                    {
                        lbModelSelect.Items[currentIndex] = ("Allarus Custodian w/ " + Weapons[currentIndex * 2]
                ...
                case 30:
                    ...
                    if (temp < UnitSize)
                    {
                        for (int i = temp; i < UnitSize; i++)
                        {
                            Weapons.Add("Guardian Spear");
                            Weapons.Add("");
                            lbModelSelect.Items.Add("Allarus Custodian w/ " + Weapons[currentIndex * 2]);
                        }
                    }
        ...
        {
            return "Allarus Custodians - " + Points + "pts";
        }
    }
}
