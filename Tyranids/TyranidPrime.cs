...
{
    public class TyranidPrime : Datasheets
    {
        public TyranidPrime()
        {
            DEFAULT_POINTS = 85;
            ...
            TemplateCode = "2m3k_c";
            Weapons.Add("Bonesword and Lash Whip");
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "SYNAPSE", "TYRANID PRIME"
            });
            Role = "HQ";
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            cbOption1.Text = "Adrenal Glands (+5 pts)";
        ...
        {
            return "Tyranid Prime - " + Points + "pts";
        }
    }
}