...
{
    public class Tervigon : Datasheets
    {
        public Tervigon()
        {
            DEFAULT_POINTS = 235;
            ...
            Weapons.Add("Massive Scything Talons");
            Weapons.Add("");
            Weapons.Add("");
            Keywords.AddRange(new string[]
            {
                "HIVE TENDRIL", "TYRANIDS", "<HIVE FLEET>",
                "MONSTER", "CHARACTER", "SYNAPSE", "PSYKER", "TERVIGON"
            });
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                ...
                case 17:
                    ...
                    if (chosenRelic != "Resonance Barb" && PsykerPowers.Length > 1)
                    {
