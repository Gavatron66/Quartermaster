...
{
    public class WingedHiveTyrant : Datasheets
    {
        public WingedHiveTyrant()
        {
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "MONSTER", "CHARACTER", "FLY", "SYNAPSE", "PSYKER", "HIVE TYRANT", "HORNED CHITIN", "WINGED HIVE TYRANT"
            });
        ...
        {
            return "Winged Hive Tyrant - " + Points + "pts";
        }
    }
}
