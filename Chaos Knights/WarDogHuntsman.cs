    ...
    public class WarDogHuntsman : Datasheets
    {
        ...
        public WarDogHuntsman()
        {
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "VEHICLE", "CORE", "WAR DOG-CLASS", "WAR DOG HUNTSMAN"
            });
        ...
        {
            return "War Dog Huntsman - " + Points + "pts";
        }
    }
}