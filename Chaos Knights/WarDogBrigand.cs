    ...
    public class WarDogBrigand : Datasheets
    {
        ...
        public WarDogBrigand()
        {
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "VEHICLE", "CORE", "WAR DOG-CLASS", "PTERRORSHADES", "WAR DOG BRIGAND"
            });
        ...
        {
            return "War Dog Brigand - " + Points + "pts";
        }
    }
}