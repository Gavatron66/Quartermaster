...
{
    public class KnightTyrant : Datasheets
    {
        ...
        public KnightTyrant()
        {
            ...
            TemplateCode = "2m_c";
            Weapons.Add("Brimstone Volcano Lance and Ectoplasma Decimator (+10 pts)");
            Weapons.Add("Four Gheiststrike Missiles and Twin Desecrator Cannon");
            Keywords.AddRange(new string[]
            {
                "CHAOS", "CHAOS KNIGHTS", "<QUESTOR TRAITORIS>", "<DREAD HOUSEHOLD>",
                "VEHICLE", "TITANIC", "TYRANT-CLASS", "KNIGHT TYRANT"
            });
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            cbOption1.Location = new System.Drawing.Point(panel.Controls["lblOption2"].Location.X - 16, cmbWarlord.Location.Y + 32);
            panel.Controls["lblOption4"].Location = new System.Drawing.Point(cbOption1.Location.X, cbOption1.Location.Y + 28);
            cmbOption4.Location = new System.Drawing.Point(panel.Controls["lblOption2"].Location.X + 4, cbOption1.Location.Y + 56);
            ...
            {
                "Brimstone Volcano Lance and Ectoplasma Decimator (+10 pts)",
                "Darkflame Cannon and Warpshock Harpoon"
            });
            ...
            {
                "Four Gheiststrike Missiles and Twin Desecrator Cannon",
                "Two Gheiststrike Missiles and Two Twin Desecrator Cannons (+15 pts)"
            });
            ...
            {
                cmbRelic.Items.Insert(cmbRelic.Items.IndexOf("The Traitor's Mark"), "Rune of Nak'T'Graa");
            }

            if (Factionupgrade == "Pyrothrone (+45 pts)" && !cmbRelic.Items.Contains("The Twisted Mask"))
            {
                if(repo.currentSubFaction == "<Custom>" || repo.currentSubFaction == "House Herpetrax")
                {
                    cmbRelic.Items.Add("The Twisted Mask");
                }
                else
                {
                    cmbRelic.Items.Insert(cmbRelic.Items.Count - 1, "The Twisted Mask");
                }
            }
            ...
            if (Factionupgrade == "Pyrothrone (+45 pts)" && Relic == "The Twisted Mask")
            {
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                ...
                case 16:
                    ...
                    if (Factionupgrade == "Pyrothrone (+45 pts)")
                    {
                        lblPsyker.Visible = true;
                        clbPsyker.Visible = true;
        ...
        {
            return "Knight Tyrant - " + Points + "pts";
        }
    }
}