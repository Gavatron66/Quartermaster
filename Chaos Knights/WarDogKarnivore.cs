    ...
    public class WarDogKarnivore : Datasheets
    {
        ...
        public WarDogKarnivore()
        {
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "VEHICLE", "CORE", "WAR DOG-CLASS", "PTERRORSHADES", "WAR DOG KARNIVORE"
            });
        ...
        {
            return "War Dog Karnivore - " + Points + "pts";
        }
    }
}