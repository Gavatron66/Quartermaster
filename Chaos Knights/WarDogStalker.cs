...
{
    public class WarDogStalker : Datasheets
    {
        string dreadbladeBond = string.Empty;
        string stratWarlordTrait;
        string extraBond = string.Empty;

        public WarDogStalker()
        {
            DEFAULT_POINTS = 145;
            Points = DEFAULT_POINTS;
            TemplateCode = "3m_c";
            Weapons.Add("Havoc Multi-launcher (+5 pts)");
            Weapons.Add("Slaughterclaw");
            Weapons.Add("Avenger Chaincannon");
            Keywords.AddRange(new string[]
            {
                "CHAOS", "CHAOS KNIGHTS", "<QUESTOR TRAITORIS>", "<DREAD HOUSEHOLD>",
                "VEHICLE", "CORE", "WAR DOG-CLASS", "PTERRORSHADES", "WAR DOG STALKER"
            });
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            if (Weapons[0] == "Havoc Multi-launcher (+5 pts)")
            {
                Points += 5;
            }
        }
        ...
        {
            return "War Dog Stalker - " + Points + "pts";
        }
    }
}