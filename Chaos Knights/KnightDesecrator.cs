    ...
    public class KnightDesecrator : Datasheets
    {
        ...
        public KnightDesecrator()
        {
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "VEHICLE", "TITANIC", "CORE", "ABHORRENT-CLASS", "KNIGHT DESECRATOR"
            });
        ...
        {
            return "Knight Desecrator - " + Points + "pts";
        }
    }
}