...
{
    public class Banehammer : Datasheets
    {
        public Banehammer()
        {
            DEFAULT_POINTS = 400;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "VEHICLE", "TRANSPORT", "TITANIC", "SMOKE", "ARMOURED", "REGIMENTAL", "SUPER-HEAVY", "BANEHAMMER"
            });
            Role = "Lord of War";
        }
