...
{
    public class ArmouredSentinels : Datasheets
    {
        int currentIndex;

        public ArmouredSentinels()
        {
            DEFAULT_POINTS = 45;
            UnitSize = 1;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "VEHICLE", "SENTINEL", "CORE", "PLATOON", "SMOKE", "REGIMENTAL", "SQUADRON", "ARMOURED", "ARMOURED SENTINELS"
            });
            Role = "Fast Attack";
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            {
                lbModelSelect.Items.Add("Armoured Sentinel w/ " + Weapons[i * 3]);
            }
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                case 11:
                    ...
                    lbModelSelect.Items[currentIndex] = "Armoured Sentinel w/ " + Weapons[currentIndex * 3];
                    break;
                case 21:
        ...
        {
            return "Armoured Sentinels - " + Points + "pts";
        }
    }
}
