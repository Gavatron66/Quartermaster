...
{
    public class Stormlord : Datasheets
    {
        public Stormlord()
        {
            DEFAULT_POINTS = 430;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "VEHICLE", "TRANSPORT", "TITANIC", "SMOKE", "ARMOURED", "REGIMENTAL", "SUPER-HEAVY", "STORMLORD"
            });
            Role = "Lord of War";
        }
