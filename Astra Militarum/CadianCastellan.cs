...
{
    public class CadianCastellan : Datasheets
    {
        public CadianCastellan()
        {
            DEFAULT_POINTS = 50;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "OFFICER", "REGIMENTAL", "COMMANDANT", "CASTELLAN"
            });
            Role = "HQ";
        }
        ...
        {
            return "Cadian Castellan - " + Points + "pts";
        }
    }
}