...
{
    public class Commissar : Datasheets
    {
        public Commissar()
        {
            DEFAULT_POINTS = 40;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "OFFICIO PREFECTUS", "OFFICER", "COMMISSAR"
            });
            Role = "Elites";
        }
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                ...
                case 17:
                    ...
                    if(chosenRelic == "The Emperor's Benediction")
                    {
                        cmbOption1.SelectedIndex = 0;
                        cmbOption1.Enabled = false;
                    }
                    else if(chosenRelic == "Legacy of Kalladius")
                    {
            ...
            {
                if (weapon == "Plasma Pistol (+5 pts)" || weapon == "Power Sword (+5 pts)")
                {
                    Points += 5;
                }
            }
