...
{
    public class TormentbringerHellflayer : Datasheets
    {
        public TormentbringerHellflayer()
        {
            DEFAULT_POINTS = 110;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "VEHICLE", "CHARACTER", "DAEMON", "PSYKER", "HELLFLAYER", "HERALD", "DAEMONETTES", "TORMENTBRINGER"
            });
        ...
        {
            return new TormentbringerHellflayer();
        }
        ...
        {
            return "Tormentbringer on Hellflayer - " + Points + "pts";
        }
    }
}
