...
{
    public class Tranceweaver : Datasheets
    {
        public Tranceweaver()
        {
            DEFAULT_POINTS = 70;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "DAEMON", "PSYKER", "DAEMONETTES", "HERALD", "TRANCEWEAVER"
            });
        ...
        {
            return "Tranceweaver - " + Points + "pts";
        }
    }
}
