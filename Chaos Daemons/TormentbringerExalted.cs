...
{
    public class TormentbringerExalted : Datasheets
    {
        public TormentbringerExalted()
        {
            DEFAULT_POINTS = 120;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "VEHICLE", "CHARACTER", "DAEMON", "PSYKER", "EXALTED SEEKER CHARIOT", "HERALD", "DAEMONETTES", "TORMENTBRINGER"
            });
        ...
        {
            return new TormentbringerExalted();
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            List<string> traits = repo.GetWarlordTraits("SLAANESH");
        ...
        {
            return "Tormentbringer on Exalted Seeker Chariot - " + Points + "pts";
        }
    }
}
