...
{
    public class Belakor : Datasheets
    {
        public Belakor()
        {
            DEFAULT_POINTS = 420;
            ...
            {
                "CHAOS", "LEGIONES DAEMONICA", "KHORNE", "TZEENTCH", "NURGLE", "SLAANESH",
                "MONSTER", "CHARACTER", "DAEMON", "PSYKER", "WARP LOCUS", "SUPREME COMMANDER", "FLY", "DAEMON PRINCE", "BE'LAKOR"
            });
            PsykerPowers = new string[2] { string.Empty, string.Empty };
            WarlordTrait = "Shadow Lord";
            Role = "HQ";
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            psykerpowers = repo.GetPsykerPowers("NOCTIC");
