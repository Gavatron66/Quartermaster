...
{
    public class Fateskimmer : Datasheets
    {
        public Fateskimmer()
        {
            DEFAULT_POINTS = 150;
            ...
            Weapons.Add("Ritual Dagger");
            Weapons.Add("");
            Keywords.AddRange(new string[]
            {
                "CHAOS", "LEGIONES DAEMONICA", "TZEENTCH",
                "VEHICLE", "CHARACTER", "DAEMON", "FLY", "PSYKER", "HERALD", "HORRORS", "FATESKIMMER"
            });
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            {
                "Ritual Dagger",
                "Staff of Change (+5 pts)"
            });
            cmbOption1.SelectedIndex = cmbOption1.Items.IndexOf(Weapons[0]);

            cbOption1.Text = "Retinue of Horrors (+5 pts)";
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            if (Weapons[0] == "Staff of Change (+5 pts)")
            {
                Points += 5;
            }
