...
{
    public class TheChangeling : Datasheets
    {
        public TheChangeling()
        {
            DEFAULT_POINTS = 100;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "DAEMON", "PSYKER", "HERALD", "HORRORS", "THE CHANGELING"
            });
            PsykerPowers = new string[1] { string.Empty };
            WarlordTrait = "Warp Tether";
            Role = "HQ";
        }

        public override Datasheets CreateUnit()
        {
            return new TheChangeling();
        }
        ...
        {
            return "The Changeling - " + Points + "pts";
        }
    }
}
