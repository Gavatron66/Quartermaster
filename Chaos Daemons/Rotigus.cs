...
{
    public class Rotigus : Datasheets
    {
        public Rotigus()
        {
            DEFAULT_POINTS = 300;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "MONSTER", "CHARACTER", "DAEMON", "PSYKER", "GREATER DAEMON", "WARP LOCUS", "GREAT UNCLEAN ONE", "ROTIGUS"
            });
            PsykerPowers = new string[2] { string.Empty, string.Empty };
            WarlordTrait = "Pestilent Miasma";
            Role = "HQ";
        }
