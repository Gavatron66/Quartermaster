...
{
    public class SyllEsske : Datasheets
    {
        public SyllEsske()
        {
            DEFAULT_POINTS = 180;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "MONSTER", "CHARACTER", "DAEMON", "PSYKER", "DAEMONETTES", "HERALD", "DAEMON PRINCE", "SYLL'ESKE"
            });
            PsykerPowers = new string[2] { string.Empty, string.Empty };
            WarlordTrait = "Aura of Bewitchment";
            Role = "HQ";
        }

        public override Datasheets CreateUnit()
        {
            return new SyllEsske();
        }
