...
{
    public class TormentbringerChariot : Datasheets
    {
        public TormentbringerChariot()
        {
            DEFAULT_POINTS = 100;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "VEHICLE", "CHARACTER", "DAEMON", "PSYKER", "SEEKER CHARIOT", "HERALD", "DAEMONETTES", "TORMENTBRINGER"
            });
        ...
        {
            return new TormentbringerChariot();
        }
        ...
        {
            return "Tormentbringer on Seeker Chariot - " + Points + "pts";
        }
    }
}
