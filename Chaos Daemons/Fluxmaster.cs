...
{
    public class Fluxmaster : Datasheets
    {
        public Fluxmaster()
        {
            DEFAULT_POINTS = 110;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "DAEMON", "FLY", "PSYKER", "HERALD", "HORRORS", "FLUXMASTER"
            });
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            cbOption1.Text = "Staff of Change (+5 pts)";
