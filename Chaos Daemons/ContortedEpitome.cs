...
{
    public class ContortedEpitome : Datasheets
    {
        public ContortedEpitome()
        {
            DEFAULT_POINTS = 160;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "CAVALRY", "CHARACTER", "DAEMON", "PSYKER", "DAEMONETTES", "HERALD", "CONTORTED EPITOME"
            });
        ...
        {
            return "Contorted Epitome - " + Points + "pts";
        }
    }
}
