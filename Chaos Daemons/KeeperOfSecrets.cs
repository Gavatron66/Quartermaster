...
{
    public class KeeperOfSecrets : Datasheets
    {
        public KeeperOfSecrets()
        {
            ...
            TemplateCode = "1m_pc";
            Weapons.Add("Ritual Knife");
            Keywords.AddRange(new string[]
            {
                "CHAOS", "LEGIONES DAEMONICA", "SLAANESH",
                "MONSTER", "CHARACTER", "DAEMON", "PSYKER", "GREATER DAEMON", "KEEPER OF SECRETS"
            });
        ...
        {
            return "Keeper of Secrets - " + Points + "pts";
        }
    }
}