...
{
    public class Skarbrand : Datasheets
    {
        public Skarbrand()
        {
            DEFAULT_POINTS = 330;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "MONSTER", "CHARACTER", "DAEMON", "GREATER DAEMON", "WARP LOCUS", "BLOODTHIRSTER", "SKARBRAND"
            });
