...
{
    public class KnightPreceptor : Datasheets
    {
        ...
        public KnightPreceptor()
        {
            DEFAULT_POINTS = 420;
            Points = DEFAULT_POINTS;
            TemplateCode = "3m_pc";
            Weapons.Add("Preceptor Multi-laser");
            Weapons.Add("Reaper Chainsword");
            Weapons.Add("(None)");
            Keywords.AddRange(new string[]
            {
                "IMPERIUM", "IMPERIAL KNIGHTS", "<QUESTOR ALLEGIANCE>", "<NOBLE HOUSEHOLD>",
                "VEHICLE", "TITANIC", "QUESTORIS-CLASS", "MENTOR", "KNIGHT PRECEPTOR"
            });
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            clbPsyker.Location = new System.Drawing.Point(clbPsyker.Location.X, clbPsyker.Location.Y - 16);
            cbOption1.Location = new System.Drawing.Point(clbPsyker.Location.X, clbPsyker.Location.Y + clbPsyker.Height + 8);
        ...
        {
            return "Knight Preceptor - " + Points + "pts";
        }
    }
}