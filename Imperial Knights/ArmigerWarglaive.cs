...
{
    public class ArmigerWarglaive : Datasheets
    {
        ...
        public ArmigerWarglaive()
        {
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "VEHICLE", "CORE", "ARMIGER-CLASS", "ARMIGER WARGLAIVE"
            });
            Role = "Lord of War";
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            cmbOption6.Items.AddRange(repo.GetWarlordTraits("Armiger").ToArray());
        ...
        {
            return "Armiger Warglaive - " + Points + "pts";
        }
    }
}