...
{
    public class KnightValiant : Datasheets
    {
        ...
        public KnightValiant()
        {
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "VEHICLE", "TITANIC", "DOMINUS-CLASS", "KNIGHT VALIANT"
            });
            Role = "Lord of War";
        }
        ...
        {
            return "Knight Valiant - " + Points + "pts";
        }
    }
}