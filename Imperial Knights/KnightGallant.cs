...
{
    public class KnightGallant : Datasheets
    {
        ...
        public KnightGallant()
        {
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "VEHICLE", "TITANIC", "QUESTORIS-CLASS", "KNIGHT GALLANT"
            });
            Role = "Lord of War";
        }
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            if (Weapons[1] != "(None)")
            {
                if (Weapons[1] == "Stormspear Rocket Pod (+40 pts)")
                {
                    Points += 40;
                }
                else
        ...
        {
            return "Knight Gallant - " + Points + "pts";
        }
    }
}