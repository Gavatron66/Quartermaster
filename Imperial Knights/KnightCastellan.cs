...
{
    public class KnightCastellan : Datasheets
    {
        ...
        public KnightCastellan()
        {
            DEFAULT_POINTS = 610;
            Points = DEFAULT_POINTS;
            TemplateCode = "1m_c";
            Weapons.Add("Four Shieldbreaker Missiles and Twin Shieldbreaker Cannon");
            Keywords.AddRange(new string[]
            {
                "IMPERIUM", "IMPERIAL KNIGHTS", "<QUESTOR ALLEGIANCE>", "<NOBLE HOUSEHOLD>",
                "VEHICLE", "TITANIC", "DOMINUS-CLASS", "KNIGHT CASTELLAN"
            });
            Role = "Lord of War";
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            {
                "Four Shieldbreaker Missiles and Twin Shieldbreaker Cannon",
                "Two Shieldbreaker Missiles and Two Twin Shieldbreaker Cannons (+15 pts)"
            });
            ...
            panel.Controls["lblOption6"].Location = new System.Drawing.Point(cbWarlord.Location.X, panel.Controls["lblOption4"].Location.Y + 64);
            ...
            panel.Controls["lblOption5"].Location = new System.Drawing.Point(cbWarlord.Location.X, panel.Controls["lblOption6"].Location.Y + 64);
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            if (Weapons[0] != "Four Shieldbreaker Missiles and Twin Shieldbreaker Cannon")
            {
                Points += 15;
            }
        }
        ...
        {
            return "Knight Castellan - " + Points + "pts";
        }
    }
}