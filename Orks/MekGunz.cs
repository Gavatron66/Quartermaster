...
{
    public class MekGunz : Datasheets
    {
        int currentIndex;
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            {
                lbModelSelect.Items.Add("Mek Gun w/ " + Weapons[i]);
            }
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                ...
                case 30:
                    ...
                    {
                        Weapons.Add("Smasha Gun");
                        lbModelSelect.Items.Add("Mek Gun w/ " + Weapons[UnitSize - 1]);
                    }
            ...
            {
                if(weapon == "Kustom Mega-kannon (+5 pts)")
                {
                    Points += 5;
                }
            }
