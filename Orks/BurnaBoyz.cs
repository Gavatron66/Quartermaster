...
{
    public class BurnaBoyz : Datasheets
    {
        int currentIndex;
        ...
        public BurnaBoyz()
        {
            DEFAULT_POINTS = 10;
            UnitSize = 4;
            Points = UnitSize * DEFAULT_POINTS + 10;
            TemplateCode = "NL1m";
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                ...
                case 30:
                    ...
                    panel.Controls["lblExtra1"].Text = "One Spanner is included for every 4 Burna Boyz \n" +
