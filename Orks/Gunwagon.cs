...
{
    public class Gunwagon : Datasheets
    {
        public Gunwagon()
        {
            DEFAULT_POINTS = 150;
            ...
            {
                "ORKS", "<CLAN>",
                "VEHICLE", "TRANSPORT", "WAGON", "GUNWAGON"
            });
            Role = "Heavy Support";
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            cbOption2.Text = "Deff Rolla (+15 pts)";
            ...
            cbOption3.Text = "Grabbin' Klaw (+5 pts)";
            ...
            cbOption4.Text = "Wreckin' Ball (+5 pts)";
            ...
            nudOption1.Value = Convert.ToInt32(Weapons[5].ToString());
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                ...
                case 24:
                    ...
                    break;
                case 31:
                    Weapons[5] = nudOption1.Value.ToString();
                    break;
            }
