...
{
	public class BigMekForceField : Datasheets
	{
		public BigMekForceField()
		{
			DEFAULT_POINTS = 85;
			UnitSize = 1;
		...
		{
			return "Big Mek w/ Kustom Force Field - " + Points + "pts";
		}
	}
}
