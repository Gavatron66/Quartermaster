...
{
    public class BeastSnaggaBoyz : Datasheets
    {
        public BeastSnaggaBoyz()
        {
            DEFAULT_POINTS = 10;
            UnitSize = 10;
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            nudOption1.Maximum = UnitSize / 10;
            nudOption1.Value = Convert.ToInt32(Weapons[0]);
            panel.Controls["lblnud1"].Text = "Thump Guns (+5 pts, 1/10x models):";
        ...
        {
            return "Beast Snagga Boyz - " + Points + "pts";
        }
    }
}
