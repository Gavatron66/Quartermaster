...
{
    public class HekatrixBloodbrides : Datasheets
    {
        int currentIndex;
        int[] restriction = new int[] { 0, 0, 0 };
        public HekatrixBloodbrides()
        {
            DEFAULT_POINTS = 13;
            UnitSize = 5;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CORE", "HAYWIRE GRENADES", "HEKATRIX BLOODBRIDES"
            });
            Role = "Troops";
        }
        ...
        {
            return new HekatrixBloodbrides();
        }
        ...
        {
            return "Hekatrix Bloodbrides - " + Points + "pts";
        }
    }
}