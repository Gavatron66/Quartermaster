...
{
    public class KabaliteTrueborn : Datasheets
    {
        int currentIndex;
        int[] restriction = new int[] { 0, 0 };

        public KabaliteTrueborn()
        {
            DEFAULT_POINTS = 11;
            UnitSize = 5;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CORE", "KABALITE TRUEBORN"
            });
            Role = "Troops";
        }
        ...
        {
            return "Kabalite Trueborn - " + Points + "pts";
        }
    }
}