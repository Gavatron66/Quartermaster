...
namespace Roster_Builder.Adepta_Sororitas
{
    public class DominionSquad : Datasheets
    {
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            for (int i = 1; i < UnitSize; i++)
            {
                lbModelSelect.Items.Add("Dominion with " + Weapons[i + 2]);
            }
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                case 11:
                    if (!restrictedIndexes.Contains(cmbOption1.SelectedIndex))
                    {
                        ...
                        else
                        {
                            ...
                            lbModelSelect.Items[currentIndex] = "Dominion with " + Weapons[currentIndex + 2];
                        }
                    }
                    else
                    {
                ...
                case 30:
                    ...
                    {
                        Weapons.Add("Boltgun");
                        lbModelSelect.Items.Add("Dominion with " + Weapons[temp + 2]);
                    }
                ...
                case 61:
                    ...
                    if (restrictArray[0] == 4 && Weapons[currentIndex + 2] == "Boltgun")
                    {
