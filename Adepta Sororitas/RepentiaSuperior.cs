...
{
    public class RepentiaSuperior : Datasheets
    {
        public RepentiaSuperior()
        {
            DEFAULT_POINTS = 40;
            UnitSize = 1;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "REPENTIA SUPERIOR"
            });
            Role = "Elites";
        }
        ...
        {
            return "Repentia Superior - " + Points + "pts";
        }
    }
}
