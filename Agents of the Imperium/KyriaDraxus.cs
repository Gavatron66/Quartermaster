...
{
    public class KyriaDraxus : Datasheets
    {
        public KyriaDraxus()
        {
            DEFAULT_POINTS = 85;
            ...
            {
                "IMPERIUM", "INQUISITION", "ORDO XENOS", "AGENTS OF THE IMPERIUM",
                "CHARACTER", "INFANTRY", "PSYKER", "INQUISITOR", "KRYIA DRAXUS"
            });
        ...
        {
            return "Lord Inquisitor Kyria Draxus - " + Points + "pts";
        }
    }
}
