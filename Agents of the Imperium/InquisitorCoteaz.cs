...
{
    public class InquisitorCoteaz : Datasheets
    {
        public InquisitorCoteaz()
        {
            DEFAULT_POINTS = 95;
            UnitSize = 1;
            ...
            {
                "IMPERIUM", "INQUISITION", "ORDO MALLEUS", "AGENTS OF THE IMPERIUM",
                "CHARACTER", "INFANTRY", "INQUISITOR", "PSYKER", "COTEAZ"
            });
        ...
        {
            return "Inquisitor Coteaz - " + Points + "pts";
        }
    }
}
