...
{
    public class EldradUlthran : Datasheets
    {
        public EldradUlthran()
        {
            DEFAULT_POINTS = 145;
            ...
            {
                "AELDARI", "ASURYANI", "ULTHWÉ",
                "CHARACTER", "INFANTRY", "PSYKER", "FARSEER", "ELDRAD ULTHRAN"
            });
            PsykerPowers = new string[3] { string.Empty, string.Empty, string.Empty };
            WarlordTrait = "Fate Reader";
            Role = "HQ";
        }

        public override Datasheets CreateUnit()
        {
            return new EldradUlthran();
        }
        ...
        {
            return "Eldrad Ulthran - " + Points + "pts";
        }
    }
}
