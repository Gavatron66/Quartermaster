    ...
    public class TroupeMaster : Datasheets
    {
        public TroupeMaster()
        {
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "CHARACTER", "INFANTRY", "HAYWIRE GRENADES", "TROUPE MASTER"
            });
            Role = "HQ";
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            {
                "Aeldari Power Sword (+5 pts)",
                "Harlequin's Blade",
                "Harlequin's Caress (+10 pts)",
                "Harlequin's Embrace (+10 pts)",
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            if(Weapons.Contains("Aeldari Power Sword (+5 pts)") || Weapons.Contains("Fusion Pistol (+5 pts)") ||
               Weapons.Contains("Neuro Disruptor (+5 pts)"))
            {
                Points += 5;
            }

            if (Weapons.Contains("Harlequin's Caress (+10 pts)") || Weapons.Contains("Harlequin's Embrace (+10 pts)") ||
               Weapons.Contains("Harlequin's Kiss (+10 pts)"))
            {
                Points += 10;
            }
        }
        ...
        {
            return "Troupe Master - " + Points + "pts";
        }
    }
}