...
{
    public class LordOnJuggernaut : Datasheets
    {
        public LordOnJuggernaut()
        {
            DEFAULT_POINTS = 125;
            UnitSize = 1;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "CAVALRY", "CHARACTER", "DAEMON", "WORLD EATERS LORD"
            });
            Role = "HQ";
        }
        ...
        {
            return "World Eaters Lord on Juggernaut - " + Points + "pts";
        }
    }
}
