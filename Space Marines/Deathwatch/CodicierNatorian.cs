...
{
    public class CodicierNatorian : Datasheets
    {
        public CodicierNatorian()
        {
            DEFAULT_POINTS = 90;
            UnitSize = 1;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "PSYKER", "LIBRARIAN", "CODICIER NATORIAN"
            });
            PsykerPowers = new string[2] { string.Empty, string.Empty };
            WarlordTrait = "Nowhere to Hide";
            Role = "HQ";
        }

        public override Datasheets CreateUnit()
        {
            return new CodicierNatorian();
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            psykerpowers = repo.GetPsykerPowers("Xenopurge");
        ...
        {
            return "Codicier Natorian - " + Points + "pts";
        }
    }
}
