...
{
    public class DeathwatchTerminators : Datasheets
    {
        int currentIndex;
        int restriction = 1;
        public DeathwatchTerminators()
        {
            DEFAULT_POINTS = 35;
            UnitSize = 5;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CORE", "TERMINATOR", "DEATHWATCH TERMINATOR SQUAD"
            });
            Role = "Elites";
        }
        ...
        {
            return new DeathwatchTerminators();
        }
            ...
            switch (code)
            {
                ...
                case 12:
                    if (!restrictedIndexes.Contains(cmbOption2.SelectedIndex))
                    {
                        ...
                        if (currentIndex == 0)
                        {
                            if (Weapons[(currentIndex * 2) + 2] == "Two Lightning Claws" || Weapons[(currentIndex * 2) + 2] == "Thunder Hammer and Storm Shield")
                            {
                                lbModelSelect.Items[0] = "Terminator Sergeant w/ " + Weapons[2];
                        ...
                        else
                        {
                            if (Weapons[(currentIndex * 2) + 2] == "Two Lightning Claws" || Weapons[(currentIndex * 2) + 2] == "Thunder Hammer and Storm Shield")
                            {
                                lbModelSelect.Items[currentIndex] = "Terminator w/ " + Weapons[(currentIndex * 2) + 2];
                                cmbOption1.Enabled = false;
                            }
                            else
                            {
                ...
                case 17:
                    ...
                    {
                        restrictedIndexes.AddRange(new int[] { 5, 6 });
                    }
                ...
                case 30:
                    ...
                    if (temp < UnitSize)
                    {
                        for (int i = temp; i < UnitSize; i++)
                        {
                            Weapons.Add("Storm Bolter");
                            Weapons.Add("Power Fist");
                            lbModelSelect.Items.Add("Terminator w/ " + Weapons[(temp * 2) + 1]
                ...
                case 61:
                    ...
                    else
                    {
                        ...
                        if ((restriction == 3 && Weapons[(currentIndex * 2) + 1] == "Storm Bolter") || currentIndex == 0)
                        {
                            cmbOption1.Enabled = false;
                        }
        ...
        {
            return "Deathwatch Terminator Squad - " + Points + "pts";
        }
    }
}