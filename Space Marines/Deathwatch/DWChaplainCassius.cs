...
{
    public class DWChaplainCassius : Datasheets
    {
        public DWChaplainCassius()
        {
            DEFAULT_POINTS = 85;
            UnitSize = 1;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "PRIEST", "CHAPLAIN", "CASSIUS"
            });
            PsykerPowers = new string[1] { string.Empty };
            WarlordTrait = "Optimised Priority";
            Role = "HQ";
        }

        public override Datasheets CreateUnit()
        {
            return new DWChaplainCassius();
        }
