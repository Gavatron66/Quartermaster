...
{
    public class GladiatorReaper : Datasheets
    {
        public GladiatorReaper()
        {
            DEFAULT_POINTS = 150;
            UnitSize = 1;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "VEHICLE", "GLADIATOR", "REPULSOR FIELD", "GLADIATOR REAPER"
            });
            role = "Heavy Support";
        }
        ...
        {
            return "Gladiator Reaper - " + Points + "pts";
        }
    }
}
