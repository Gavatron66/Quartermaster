...
{
    public class Ezekiel : Datasheets
    {
        public Ezekiel()
        {
            DEFAULT_POINTS = 105;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "CHARACTER", "INFANTRY", "DEATHWING", "INNER CIRCLE", "PSYKER", "LIBRARIAN", "CHIEF LIBRARIAN", "EZEKIEL"
            });
            PsykerPowers = new string[3] { string.Empty, string.Empty, string.Empty };
            WarlordTrait = "Stubborn Tenacity";
            Role = "HQ";
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            psykerpowers = repo.GetPsykerPowers("Interromancy");
