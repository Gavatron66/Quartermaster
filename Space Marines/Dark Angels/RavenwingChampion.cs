...
{
    public class RavenwingChampion : Datasheets
    {
        private string stratWarlordTrait;

        public RavenwingChampion()
        {
            DEFAULT_POINTS = 60;
            Points = DEFAULT_POINTS;
            TemplateCode = "1m_c";
            Weapons.Add("Astartes Grenade Launcher");
            Keywords.AddRange(new string[]
            {
                "IMPERIUM", "ADEPTUS ASTARTES", "DARK ANGELS",
                "BIKER", "CHARACTER", "INNER CIRCLE", "RAVENWING", "COMPANY CHAMPION", "RAVENWING CHAMPION"
            });
            Role = "Elites";
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            else
            {
                ...
                {
                    cmbWarlord.Items.Add("Martial Exemplar");
                    cmbRelic.Items.Add("Blade of Triumph");
                }
            }
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                ...
                case 16:
                    ...
                    {
                        if (Relic == "Blade of Triumph")
                        {
                            cmbRelic.SelectedIndex = 0;
                        }

                        if (WarlordTrait == "Martial Exemplar")
                        {
                            cmbWarlord.SelectedIndex = -1;
                        }

                        cmbWarlord.Items.Remove("Martial Exemplar");
                        cmbRelic.Items.Remove("Blade of Triumph");
                    }
                    break;
                case 17:
        ...
        {
            return "Ravenwing Champion - " + Points + "pts";
        }
    }
}