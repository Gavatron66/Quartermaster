...
{
    public class RavenwingApothecary : Datasheets
    {
        private string stratWarlordTrait;

        public RavenwingApothecary()
        {
            DEFAULT_POINTS = 90;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "BIKER", "CHARACTER", "INNER CIRCLE", "RAVENWING", "APOTHECARY", "RAVENWING APOTHECARY"
            });
            Role = "Elites";
        }
        ...
        {
            return new RavenwingApothecary();
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            else
            {
                ...
                {
                    cmbWarlord.Items.Add("Selfless Healer");
                    cmbRelic.Items.Add("Acquittal");
                }
            }
            ...
            switch (code)
            {
                ...
                case 16:
                    ...
                    else
                    {
                        ...
                        if (WarlordTrait == "Selfless Healer")
                        {
                            cmbWarlord.SelectedIndex = -1;
                        }

                        cmbWarlord.Items.Remove("Selfless Healer");
                        cmbRelic.Items.Remove("Acquittal");
                    }
                    break;
                case 17:
        ...
        {
            return "Ravenwing Apothecary - " + Points + "pts";
        }
    }
}