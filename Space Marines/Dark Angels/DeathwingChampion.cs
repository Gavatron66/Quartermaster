...
{
    public class DeathwingChampion : Datasheets
    {
        private string stratWarlordTrait;

        public DeathwingChampion()
        {
            DEFAULT_POINTS = 70;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "CHARACTER", "INFANTRY", "TERMINATOR", "DEATHWING", "INNER CIRCLE",
                "COMPANY CHAMPION", "DEATHWING CHAMPION"
            });
            Role = "Elites";
        }
        ...
        {
            return "Deathwing Champion - " + Points + "pts";
        }
    }
}