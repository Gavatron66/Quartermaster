...
{
    public class DeathwingTerminators : Datasheets
    {
        int currentIndex;
        int restriction = 0;

        public DeathwingTerminators()
        {
            DEFAULT_POINTS = 33;
            UnitSize = 5;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CORE", "TERMINATOR", "DEATHWING", "INNER CIRCLE", "DEATHWING TERMINATOR SQUAD"
            });
            Role = "Elites";
        }
        ...
        {
            return new DeathwingTerminators();
        }
                ...
                case 61:
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (restriction == UnitSize / 5 && cmbOption1.Items.IndexOf(Weapons[(currentIndex * 2) + 1]) >= 5)
                            {
        ...
        {
            return "Deathwing Terminator Squad - " + Points + "pts";
        }
    }
}