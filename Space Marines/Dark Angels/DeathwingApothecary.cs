...
{
    public class DeathwingApothecary : Datasheets
    {
        private string stratWarlordTrait;
        public DeathwingApothecary()
        {
            DEFAULT_POINTS = 90;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "APOTHECARY", "DEATHWING APOTHECARY"
            });
            Role = "Elites";
        }
        ...
        {
            return new DeathwingApothecary();
        }
        ...
        {
            return "Deathwing Apothecary - " + Points + "pts";
        }
    }
}