...
{
    public class RavenwingAncient : Datasheets
    {
        private string stratWarlordTrait;

        public RavenwingAncient()
        {
            DEFAULT_POINTS = 90;
            Points = DEFAULT_POINTS;
            TemplateCode = "1m_c";
            Weapons.Add("Plasma Talon");
            Keywords.AddRange(new string[]
            {
                "IMPERIUM", "ADEPTUS ASTARTES", "DARK ANGELS",
                "BIKER", "CHARACTER", "ANCIENT", "INNER CIRCLE", "RAVENWING", "COMPANY ANCIENT", "RAVENWING ANCIENT"
            });
            Role = "Elites";
        }
        ...
        {
            return "Ravenwing Ancient - " + Points + "pts";
        }
    }
}