...
{
	public class ArjacRockfist : Datasheets
	{
		public ArjacRockfist()
		{
			DEFAULT_POINTS = 100;
			UnitSize = 1;
			TemplateCode = "nc";
			...
			Keywords.AddRange(new string[]
			{
				...
				"INFANTRY", "CHARACTER", "TERMINATOR", "WOLF GUARD", "LIEUTENANT", "ARJAC ROCKFIST"
			});
		...
		{
			return "Arjac Rockfist - " + Points + "pts";
		}
	}
}
