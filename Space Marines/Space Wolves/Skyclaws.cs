    ...
    public class Skyclaws : Datasheets
    {
        ...
        public Skyclaws()
        {
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CORE", "JUMP PACK", "MELTA BOMB", "FLY", "SKYCLAWS"
            });
            Role = "Fast Attack";
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            lbModelSelect.Items.Add("Skyclaw Pack Leader w/ " + Weapons[2] + " and " + Weapons[3]);
            if (wolfGuard == 1)
            {
                Weapons[0] = "Astartes Chainsword";
                Weapons[1] = "Bolt Pistol";
                lbModelSelect.Items.Add("Wolf Guard Pack Leader w/ " + Weapons[0] + " and " + Weapons[1]);
                for (int i = 1; i < UnitSize; i++)
                {
                    lbModelSelect.Items.Add("Skyclaw w/ " + Weapons[i + 3]);
                }
            }
            else if (wolfGuard == 0)
            {
            ...
            {
                "(None)",
                "Wolf Guard Skylcaw Pack Leader (+18 pts)",
            });
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                case 11:
                    if (!restrictedIndexes.Contains(cmbOption1.SelectedIndex))
                    {
                        ...
                        else if (currentIndex == 0)
                        {
                            ...
                            lbModelSelect.Items[0] = "Skyclaw Pack Leader w/ " + Weapons[2] + " and " + Weapons[3];
                        }
                        else
                        {
                            Weapons[currentIndex + 3] = cmbOption1.SelectedItem.ToString();
                            lbModelSelect.Items[currentIndex] = "Skyclaw w/ " + Weapons[currentIndex + 3];
                        }
                    }
                    else
                    {
                ...
                case 17:
                    ...
                    else if (chosenRelic == "Morkai's Teeth Bolts" && stratLeader == 1)
                    {
                ...
                case 30:
                    ...
                    if (temp < UnitSize + (wolfGuard == 0 ? 0 : 1))
                    {
                        ...
                        {
                            Weapons.Add("Bolt Pistol");
                            lbModelSelect.Items.Add("Skyclaw w/ " + Weapons[temp + 3 - (wolfGuard == 0 ? 0 : 1)]);
                        }
                    }
                ...
                case 61:
                    ...
                    else
                    {
                        ...
                        if (restrict[0] == 2 && (Weapons[currentIndex + 3] == "Bolt Pistol"))
                        {
                            restrictedIndexes.AddRange(new int[] { 1, 2, 3, 4, 5 });
                        }
                    }
