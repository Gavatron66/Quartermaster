...
{
    public class TychoTheLost : Datasheets
    {
        public TychoTheLost()
        {
            DEFAULT_POINTS = 95;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "DEATH COMPANY", "TYCHO", "TYCHO THE LOST"
            });
            WarlordTrait = "Selfless Valour";
            Role = "HQ";
        }

        public override Datasheets CreateUnit()
        {
            return new TychoTheLost();
        }
        ...
        {
            return "Tycho the Lost - " + Points + "pts";
        }
    }
}