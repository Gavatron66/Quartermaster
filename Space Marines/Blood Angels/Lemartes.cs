...
{
    public class Lemartes : Datasheets
    {
        public Lemartes()
        {
            DEFAULT_POINTS = 120;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "JUMP PACK", "FLY", "PRIEST", "DEATH COMPANY", "CHAPLAIN", "LEMARTES"
            });
            PsykerPowers = new string[2] { string.Empty, string.Empty };
            WarlordTrait = "Soulwarden";
            Role = "HQ";
        }
