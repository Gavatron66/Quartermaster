...
{
    public class SanguinaryAncient : Datasheets
    {
        private string stratWarlordTrait;

        public SanguinaryAncient()
        {
            DEFAULT_POINTS = 110;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "ANCIENT", "JUMP PACK", "FLY", "SANGUINARY GUARD", "SANGUINARY ANCIENT"
            });
            Role = "Elites";
        }
        ...
        {
            return "Sanguinary Ancient - " + Points + "pts";
        }
    }
}