...
{
    public class SanguinaryPriest : Datasheets
    {
        ...
        public SanguinaryPriest()
        {
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "APOTHECARY", "SANGUINARY PRIEST"
            });
            Role = "HQ";
        }
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            cbOption1.Text = "Jump Pack (+30 pts)";
        ...
        {
            return "Sanguinary Priest - " + Points + "pts";
        }
    }
}