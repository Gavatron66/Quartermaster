...
{
    public class Mephiston : Datasheets
    {
        public Mephiston()
        {
            DEFAULT_POINTS = 125;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "LIBRARIAN", "PRIMARIS", "PSYKER", "CHIEF LIBRARIAN", "MEPHISTON"
            });
            PsykerPowers = new string[3] { string.Empty, string.Empty, string.Empty };
            WarlordTrait = "Speed of the Primarch";
            Role = "HQ";
        }

        public override Datasheets CreateUnit()
        {
            return new Mephiston();
        }
        ...
        {
            return "Chief Librarian Mephiston - " + Points + "pts";
        }
    }
}
