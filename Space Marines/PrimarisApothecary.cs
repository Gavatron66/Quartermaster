...
{
    public class PrimarisApothecary : Datasheets
    {
        private string stratWarlordTrait;
        public PrimarisApothecary()
        {
            DEFAULT_POINTS = 70;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "INFANTRY", "CHARACTER", "PRIMARIS", "APOTHECARY"
            });
            Role = "Elites";
        }
        ...
        {
            return "Primaris Apothecary - " + Points + "pts";
        }
    }
}