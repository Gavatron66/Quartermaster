...
namespace Roster_Builder.Leagues_of_Votann
{
    public class Kâhl : Datasheets
    {
        public Kâhl()
        {
            ...
            TemplateCode = "3m_c";
            Weapons.Add("Autoch-pattern Combi-bolter");
            Weapons.Add("Forgewrought Plasma Axe");
            Weapons.Add("Rampart Crest (+10 pts)");
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            if (Weapons[1] == "Mass Gauntlet (+10 pts)")
            {
                Points += 10;
            }

            if (Weapons[2] == "Rampart Crest (+10 pts)")
            {
                Points += 10;
            }
        }
