...
namespace Roster_Builder.Chaos_Space_Marines
{
    ...
    {
        int currentIndex;
        //Most of this code is copied from Death Guard Plague Marines with the appropriate adjustments being made.
        //That is why this code is different than the rest of CSM, since I did DG a long time ago, before I figured out my flow
        //Simply saw no need to redo code that I know works

        public PlagueMarinesCSM()
        {
            DEFAULT_POINTS = 19;
            UnitSize = 5;
            Points = DEFAULT_POINTS * UnitSize + 15;
            TemplateCode = "NL2m3k";
