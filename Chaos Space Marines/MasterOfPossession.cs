...
{
    public class MasterOfPossession : Datasheets
    {
        private string stratWarlordTrait;
        public MasterOfPossession()
        {
            DEFAULT_POINTS = 105;
            UnitSize = 1;
            ...
            Keywords.AddRange(new string[]
            {
                ...
                "CHARACTER", "INFANTRY", "PSYKER", "WARP LOCUS", "DAEMONKIN", "MASTER OF POSSESSION"
            });
        ...
        public override void LoadDatasheets(Panel panel, Faction f)
        {
            ...
            psykerpowers = repo.GetPsykerPowers("Malefic");
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                ...
                case 17:
                    ...
                    if (chosenRelic == "G'holl'ax, the Decayed" || chosenRelic == "Orb of Unlife")
                    {
        ...
        {
            return "Master of Possession - " + Points + "pts";
        }
    }
}
