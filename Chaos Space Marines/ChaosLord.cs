...
{
    public class ChaosLord : Datasheets
    {
        ...
        public override void SaveDatasheets(int code, Panel panel)
        {
            ...
            switch (code)
            {
                ...
                case 17:
                    ...
                    else if (chosenRelic == "The Warp's Malice" || chosenRelic == "Loyalty's Reward" || chosenRelic == "Viper's Spite"
                        || chosenRelic == "Hydra's Teeth" || chosenRelic == "Hyper-Growth Bolts")
                    {
                        //Bolt Pistol
                        cmbOption2.SelectedIndex = 1;
                        cmbOption2.Enabled = false;
                    }
                    else if (chosenRelic == "Ghorisvex's Teeth" || chosenRelic == "Blade of the Hydra")
                    {
                        //Astartes Chainsword
                        cmbOption1.SelectedIndex = 0;
                        cmbOption1.Enabled = false;
                    }
                    else if (chosenRelic == "Wrath of the Abyss")
                    {
                        //Thunder Hammer
            ...
            if (Weapons[0] == "Thunder Hammer (+10 pts)")
            {
                Points += 10;
            }
        }
